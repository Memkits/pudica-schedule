...
{} (:about "|Machine-generated snapshot. Do not edit directly — changes will be overwritten. Use `cr query` to inspect and `cr edit`/`cr tree` to modify. Run `cr docs agents --full` first. Manual edits must follow format and schema conventions, then run `cr edit format`.") (:package |app)
  ...
  :files $ {}
                ...
                div
                  {}
                    ...
                    :on $ {}
                      ...
                      :dragend $ fn (e d!) (d! :mark/dragging nil) (d! :mark/dropping nil)
                      :dragenter $ fn (e d!)
          ...
          :code $ quote
            defstyle css-done $ {}
              |$0 $ {} (:width 20) (:height 20)
                ...
                :border-radius |50%
          :examples $ []
        |css-task $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle css-task $ {}
              ...
              |$0:hover $ {}
                ...
                :z-index 999
          :examples $ []
        |css-text $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle css-text $ {}
          ...
          :examples $ []
        |effect-in $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
                  ...
                  div $ {} (:class-name css-cursor)
                    :style $ {}
                      :top $ str
                        ...
                        , |px
          :examples $ []
        |css-cursor $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defstyle css-cursor $ {}
    ...
    |app.main $ %{} :FileEntry
      :defs $ {}
        |*reel $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          ...
          :examples $ []
        |adjust-focus! $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
    ...
    |app.updater $ %{} :FileEntry
      :defs $ {}
        |add-after $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defn add-after (store task-id op-id op-time)
              let
                ...
                -> store
                  ...
                  update :pointer inc
          :examples $ []
        |add-before $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |delete-task $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |move-task $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
          ...
          :examples $ []
        |move-task-down $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
              ...
              let-sugar
                ...
                if at-bottom? store $ let
                  ...
                  -> store
                    ...
                    update :pointer inc
          :examples $ []
        |move-task-up $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
              ...
              let-sugar
                ...
                if at-head? store $ let
                  ...
                  -> store
                    ...
                    update :pointer dec
          :examples $ []
        |relax-tasks $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defn relax-tasks (store op-id op-time)
              let
                ...
                -> store
                  ...
                  assoc :pointer 0
          :examples $ []
        |swap-tasks $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
    ...
    |app.util.dom $ %{} :FileEntry
      :defs $ {}
        |*canvas-element $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
            defatom *canvas-element $ if (exists? js/document) (js/document.createElement |canvas) nil
          :examples $ []
        |get-width $ %{} :CodeEntry (:doc |) (:schema :dynamic)
          :code $ quote
